...
public class S3AFileSystem extends FileSystem {
  ...
  public void initialize(URI name, Configuration conf) throws IOException {
    ...
    System.out.println("Custom initialize -------------------- >>>>>>>>>>>> ");
    System.out.println("URI" + name.getPath());
    System.out.println("URI" + name.getHost());
    System.out.println("URI" + name.getAuthority());
  ...
  public FileStatus[] listStatus(Path f) throws FileNotFoundException,
      IOException {
    System.out.println("\n\n" + Thread.currentThread().getStackTrace()[3].getClassName()+ ":" + Thread.currentThread().getStackTrace()[3].getMethodName() + ":" + Thread.currentThread().getStackTrace()[3].getLineNumber());
  ...
  public boolean mkdirs(Path f, FsPermission permission) throws IOException {
    ...
    System.out.println("making directory ------->>>> " + f.toString());
    try {
  ...
  public void copyFromLocalFile(boolean delSrc, boolean overwrite, Path src,
    ...
    System.out.println("\n\n -------------- copying from Local File: source = " + src.toString() + " : destination = " + dst.toString());
